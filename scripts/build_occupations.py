...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  ...
  <!-- Rankings cluster: 1 index + 4 ranking pages at /ja/rankings/<slug>. Generated by scripts/build_rankings.py. -->
{rankings}
...
def _rankings_sitemap_block(lastmod: str) -> str:
    """Emit sitemap entries for the rankings index + 4 ranking pages."""
    slugs = ["ai-risk-high", "ai-risk-low", "salary-safe", "workers"]
    parts: list[str] = []
    parts.append(
        f"  <url>\n"
