...
- **PRs** — bug fixes, translation improvements, new color layers, accessibility improvements. Visual / responsive changes must update [`docs/Design.md`](docs/Design.md) first; the doc is the spec.
