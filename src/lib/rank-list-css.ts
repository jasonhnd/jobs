...
.rank-list li::before{content:counter(rank);font-family:var(--font-serif);font-size:var(--t-h2);color:var(--fg3);display:flex;align-items:center;justify-content:center;padding-left:6px}
...
.rank-list .rl-chevron{color:var(--fg3);font-size:var(--t-h3);line-height:1}
