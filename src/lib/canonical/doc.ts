...
/* ── Lead ── */
.lead{font-size:var(--t-h3);line-height:1.8;color:var(--fg);max-width:74ch;margin-bottom:8px}
...
.emfo .n{font-size:var(--t-xs);letter-spacing:.06em;color:var(--fg2);font-weight:600}
.emfo .en{font-weight:700;font-size:var(--t-h3);margin:3px 0 3px;color:var(--fg)}
.emfo .d{font-size:var(--t-sm);color:var(--fg2);line-height:1.55}
...
table.ex thead th{color:var(--fg2);font-weight:600;font-size:var(--t-sm);background:var(--bg2)}
table.ex thead .gly{display:block;font-size:var(--t-xs);margin-top:1px}
...
.heat-caption{font-size:var(--t-xs);color:var(--fg2);margin:4px 0 14px;display:flex;align-items:center;gap:8px;flex-wrap:wrap}
...
.src-row{display:grid;grid-template-columns:172px 1fr;gap:8px 14px;padding:9px 0;border-bottom:1px solid var(--border);font-size:var(--t-sm);align-items:baseline}
.src-row:last-child{border-bottom:none}
.src-label{color:var(--fg2);font-size:var(--t-xs);text-transform:uppercase;letter-spacing:.05em}

/* ── Definition / score-band table ── */
table.bands{width:100%;border-collapse:collapse;margin:12px 0;font-size:var(--t-sm)}
table.bands th,table.bands td{padding:10px 12px;text-align:left;border-bottom:1px solid var(--border);vertical-align:top}
table.bands thead th{background:var(--bg3);font-family:var(--font-serif);font-weight:600;color:var(--fg);font-size:var(--t-sm)}
