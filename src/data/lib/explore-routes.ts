...
export const EXPLORE_ROUTES: ReadonlyArray<ExploreRoute> = [
  {
    ...
    short_ja: '業種で探す',
    title_ja: '業種から職業を探す',
    description_ja: '日本の 552 職業を 16 業種で分類。各セクターの AI 影響度や代表職業を確認できる。',
    intro_ja: '医療・福祉・教育・建設・IT・事務・販売・サービスなど、16 の業種別に職業を整理。各セクターには TOP 5 ランキング・全職業一覧・FAQ・パターン観察を含みます。',
    genres: [
      { path: 'sectors', label: '16 業種一覧', desc: '医療・福祉・建設・IT・事務など 16 セクターの職業群' },
    ],
  ...
  },
  {
    ...
    description_ja: 'AI 影響度・年収・初任給・労働時間・需要・組合せ等、41 のランキングで職業を比較できる。',
    intro_ja: '高年収 × AI 安全、人手不足、伝統技能で AI 抗性が高い等、41 種類のランキングで職業を多角的に比較。各ランキングは TOP 30 で AI 影響度・年収を併記。',
    genres: [
      { path: 'rankings', label: '41 ランキング', desc: 'AI 影響度・年収・需要・組合せ等の TOP 30 ランキング' },
    ],
  ...
  },
  {
    ...
    intro_ja: '36 のよくある質問に答える形、年代・キャリア段階別の persona、RIASEC 興味タイプ、IPD 価値観など、自己理解の 4 軸から自分に向く仕事を探せます。',
    genres: [
      { path: 'q', label: 'Q&A 36 個', desc: '具体的な質問への回答 (AI でなくならない仕事？等)' },
      ...
      { path: 'values', label: '価値観 6', desc: '達成感・自立性・関係性等を重視する人向け' },
    ],
  ...
  },
  {
    ...
    intro_ja: 'IPD のスキル・能力・知識軸 + 関連資格 + 学歴の組合せから、現在持っているスキルや今後身につけるべき能力で職業を絞り込めます。',
    genres: [
      { path: 'skills', label: 'スキル 10', desc: '批判的思考・問題解決・対人スキル・プログラミング等' },
      { path: 'licenses', label: '資格 15 カテゴリー', desc: '医療・福祉・法務・会計・建設・IT 等の資格別' },
      { path: 'abilities', label: '能力 8', desc: '持久力・筋力・空間認識・推論力等' },
      { path: 'knowledge', label: '知識 5 領域', desc: '生産・顧客サービス・機械・医学・数学' },
  ...
  },
  {
    ...
    short_ja: '働き方から探す',
    title_ja: '働き方から職業を探す',
    description_ja: '業務形態・雇用形態・修行期間・ライフ整合・入職経路の 5 軸で働き方から仕事を選べる。',
    intro_ja: '屋外/屋内・シフト勤務・正社員 vs フリーランス・育児両立・新卒 vs 中途等、働き方の特性で職業を分類。ライフスタイルとの相性を重視する人向け。',
    genres: [
      { path: 'work-styles', label: '業務形態 6', desc: '屋外・現場・移動多・シフト・チーム等' },
      { path: 'employment-types', label: '雇用形態 4', desc: '正社員・フリーランス・パート・公務員' },
      { path: 'training', label: '修行期間 4', desc: '即独立・1-3年・5-10年・生涯' },
      { path: 'life-balance', label: 'ライフ整合 5', desc: '育児・介護・健康・精神負担・趣味' },
      { path: 'entry-paths', label: '入職経路 4', desc: '新卒・中途・バイト出身・独立' },
    ],
  ...
  },
  {
    ...
    short_ja: '職業を比較する',
    title_ja: '職業を比較する',
    description_ja: '迷いやすい 12 の職業ペアを side-by-side で比較できる。',
    intro_ja: '看護師 vs 介護福祉士、SE vs プログラマー、医療事務 vs 一般事務など、迷いやすい職業ペアを並べて比較。AI 影響度・年収・労働条件・必要スキルを並べて意思決定の助けに。',
    genres: [
      { path: 'compare', label: '比較 12 ペア', desc: '迷いやすい職業ペアの side-by-side 比較' },
    ],
