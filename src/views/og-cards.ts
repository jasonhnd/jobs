...
export const PAGE_CARDS: Record<string, GenericCardConfig> = {
  home: {
    eyebrow: `JAPAN OCCUPATIONS · ${OCCUPATION_COUNT.SCORED} 職業 × AI 影響`,
    title: 'AIの時代でも、あなたらしい働き方を',
    subtitle: `${OCCUPATION_COUNT.SCORED} 職業を AI 影響度・就業者数・年収・5 次元で多角分析`,
  },
  about: {
    eyebrow: 'ABOUT',
    title: 'データについて',
    subtitle: '厚労省 jobtag · JILPT · AIOIS-10 採点の方法論',
  },
  privacy: {
    eyebrow: 'PRIVACY',
    title: 'プライバシーポリシー',
  ...
  'yearly-2026':    { eyebrow: 'REPORT 2026',        title: '2026 年版 AI と仕事',     subtitle: `${OCCUPATION_COUNT.SCORED} 職業の全量分析` },
  ...
  haid:             { eyebrow: 'HAID · 人類と AI の距離', title: '人と AI の関係を 10 段階で測る', subtitle: '無縁・道具・同席・一体の 4 つの関係、10 の段階。利用率ではなく分布で報告する公開基準 v1.0' },
};
