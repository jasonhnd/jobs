...
.haid-meta { display: flex; flex-wrap: wrap; gap: 6px 14px; margin-top: 8px; font-size: var(--t-xs); color: var(--fg2); }
...
.haid-boundary .c { font-size: var(--t-xs); color: var(--fg2); font-variant-numeric: tabular-nums; white-space: nowrap; }
.haid-boundary .t { font-family: var(--font-serif); font-weight: 600; font-size: var(--t-body); white-space: nowrap; }
...
.haid-emfo .stage .lv { margin-top: 6px; font-size: var(--t-xs); color: var(--fg2); font-variant-numeric: tabular-nums; }
