...
#wrapper{
  ...
  --shindan-soft:color-mix(in srgb, var(--orange) 8%, transparent);
  --shindan-soft-strong:color-mix(in srgb, var(--orange) 14%, transparent);
...
.shindan-hero h1 .accent{color:var(--ink)}
...
.shindan-proof strong{color:var(--fg);font-family:var(--font-serif);font-size:var(--t-h2);font-variant-numeric:tabular-nums}
...
.shindan-panel h2{margin:0 0 6px;color:var(--fg)}
.shindan-panel .sub{margin:0 0 18px;color:var(--fg2);font-size:var(--t-sm)}
.shindan-status{font-size:var(--t-sm);color:var(--fg2);margin:0 0 16px;min-height:0}
...
.shindan-progress-text{font-size:var(--t-xs);color:var(--fg2);font-variant-numeric:tabular-nums}
...
.shindan-question-meta{display:inline-flex;margin-right:8px;color:var(--accent-deep);font-size:var(--t-xs);font-weight:700;font-variant-numeric:tabular-nums}
...
.shindan-copy-grid dt{font-size:var(--t-xs);color:var(--fg2);font-weight:700;letter-spacing:.04em;margin-bottom:4px}
.shindan-copy-grid dd{margin:0;color:var(--fg);font-size:var(--t-sm);line-height:1.6}
...
.shindan-axis-name{font-weight:700;color:var(--fg);font-size:var(--t-sm)}
.shindan-axis-poles{display:flex;justify-content:space-between;color:var(--fg2);font-size:var(--t-xs);margin-bottom:5px}
...
.shindan-axis-margin{text-align:right;color:var(--fg2);font-size:var(--t-xs);font-variant-numeric:tabular-nums}
.shindan-rarity{display:inline-flex;margin:2px 0 18px;padding:6px 12px;border-radius:999px;border:1px solid color-mix(in srgb, var(--orange) 34%, transparent);background:var(--shindan-soft);color:var(--fg);font-size:var(--t-sm)}
.shindan-occupations{margin:4px 0 0}
.shindan-occupations h3,.shindan-share h3{margin:0 0 10px;color:var(--fg)}
...
.shindan-occ-list small{color:var(--fg2);font-size:var(--t-xs);font-variant-numeric:tabular-nums}
...
.shindan-gap-head h3{margin:0;color:var(--fg)}
.shindan-job-search{position:relative;margin:0 0 12px}
.shindan-job-input{width:100%;height:46px;padding:0 16px 0 42px;background:var(--bg2);color:var(--fg);border:1px solid var(--border);border-radius:999px;font-size:var(--t-body);background-image:url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='18' height='18' viewBox='0 0 24 24' fill='none' stroke='%237A6F5E' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><circle cx='11' cy='11' r='7'/><path d='m21 21-4.3-4.3'/></svg>");background-repeat:no-repeat;background-position:15px center}
.shindan-job-input:focus-visible{outline:2px solid var(--accent);outline-offset:2px;border-color:var(--accent)}
.shindan-job-listbox{position:absolute;left:0;right:0;top:100%;margin-top:6px;z-index:20;background:var(--bg2);border:1px solid var(--border);border-radius:8px;box-shadow:0 12px 28px color-mix(in srgb, var(--ink) 12%, transparent);list-style:none;padding:6px 0;max-height:340px;overflow-y:auto;display:none}
...
.shindan-job-sector{font-size:var(--t-xs);color:var(--fg2);margin-top:2px}
.shindan-job-pill{display:inline-block;padding:2px 10px;border-radius:12px;font-size:var(--t-xs);font-weight:700;font-variant-numeric:tabular-nums;white-space:nowrap}
...
.shindan-gap-meta{margin:2px 0 0;color:var(--fg2);font-size:var(--t-xs);line-height:1.5;font-variant-numeric:tabular-nums}
.shindan-gap-badge{display:inline-flex;align-items:center;justify-content:center;max-width:220px;padding:5px 10px;border-radius:999px;font-size:var(--t-xs);font-weight:700;line-height:1.35;text-align:center;background:var(--shindan-soft);color:var(--accent-deep);border:1px solid color-mix(in srgb, var(--orange) 28%, transparent)}
.shindan-gap-card[data-gap="hidden_strength"] .shindan-gap-badge{background:color-mix(in srgb, var(--accent-2) 14%, transparent);border-color:color-mix(in srgb, var(--accent-2) 34%, transparent);color:#3f7461}
.shindan-gap-card[data-gap="hidden_risk"] .shindan-gap-badge{background:color-mix(in srgb, var(--red) 10%, transparent);border-color:color-mix(in srgb, var(--red) 32%, transparent);color:#9d4a33}
...
.shindan-transfer h4{margin:0 0 8px;color:var(--fg);}
.shindan-transfer-list{display:flex;flex-wrap:wrap;gap:8px}
.shindan-transfer-list a{display:inline-flex;align-items:center;gap:6px;min-height:34px;padding:6px 10px;border:1px solid var(--border);border-radius:999px;background:var(--bg);color:var(--fg);font-size:var(--t-sm);line-height:1.3;text-decoration:none}
.shindan-transfer-list a:hover{border-color:var(--accent);color:var(--accent-deep)}
.shindan-transfer-empty{color:var(--fg2);font-size:var(--t-sm);line-height:1.5}
.shindan-disclaimer{margin:20px 0 0;padding:12px 14px;background:var(--bg);border:1px solid var(--border);border-left:3px solid var(--accent-deep);border-radius:7px;color:var(--fg2);font-size:var(--t-xs);line-height:1.7}
...
.shindan-share-hook{display:flex;gap:12px;align-items:flex-start;margin:0 0 14px;color:var(--fg);font-size:var(--t-body);line-height:1.6}
.shindan-share-hook strong{display:block;color:var(--ink);font-size:var(--t-h3)}
.shindan-trophy{font-size:var(--t-h2);line-height:1.2}
.shindan-consent{margin:0 0 10px;color:var(--fg2);font-size:var(--t-xs)}
