/**
 * src/pages/ja/licenses/_license-bindings.ts — bindings builder for
 * /ja/licenses/[license].astro. Phase D audit #7 slim (2026-05-14).
 */
...
export function buildLicenseBindings(input: LicenseBindingsInput): LicenseBindings {
  ...
  const canonical = `${SITE}/ja/licenses/${hub.slug}`;
