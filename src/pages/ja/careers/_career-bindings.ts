/**
 * src/pages/ja/careers/_career-bindings.ts — bindings builder for
 * /ja/careers/[career].astro.
 *
...
export function buildCareerBindings(input: CareerBindingsInput): CareerBindings {
  ...
  const canonical = `${SITE}/ja/careers/${persona.slug}`;
