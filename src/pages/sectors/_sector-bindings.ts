/**
 * src/pages/sectors/_sector-bindings.ts — single-entry binding
 * builder for /sectors/[sector].
 *
 ...
 * result. Sister of src/pages/_id-bindings.ts.
 *
...
import { buildSectorFaqs } from '@/views/sector-faqs';
